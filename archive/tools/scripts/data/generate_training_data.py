...
OUTPUT_FILE = os.path.join(PROJECT_ROOT, "training-data", "quant-github-generated.jsonl")
...
def collect_strategy_files():
    ...
    base = os.path.join(PROJECT_ROOT, "training-data", "github-repos", "quant-trading-master")
    ...
    base2 = os.path.join(PROJECT_ROOT, "training-data", "github-repos", "backtesting.py-master", "doc", "examples")
